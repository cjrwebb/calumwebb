...
meta() %>%
  ...
  meta_social(
    title = "The biggest problem with the funding formula for Children's Social Services
  isn't that it's too inequitable, it's that it's too relative.",
    url = "https://calumwebb.co.uk/posts/2020-04-25-the-biggest-problem-with-the-funding-formula/",
    image = "https://calumwebb.co.uk/posts/2020-04-25-the-biggest-problem-with-the-funding-formula/dog-pie.jpeg",
    image_alt = "Dog looking longingly at a meringue pie.",
    og_type = "website",
