---
title: "EDC117: Week 1 Introduction & Overview"
subtitle: ""  
author: 
  - "Dr. Calum Webb"
date: '`r Sys.Date()`'
...
For any general enquiries about administration during the module — registration, extensions, assessment submission, attendance, timetable issues, and so on — please contact [edcug@sheffield.ac.uk](mailto:edcug@sheffield.ac.uk) who will be happy to help you. Remember, as per the module outline, that module leaders cannot grant extensions.
...
* **Lectures** will mostly focus on theory and critical awareness
    * 10:00-11:00 on Tuesdays. Check your timetable for location information. Contact [edcug@sheffield.ac.uk](mailto:edcug@sheffield.ac.uk) if you have any timetable issues.

--

* **Workshops** will focus on the practice of creating data visualisations
    * We will be supported by another colleague so that there are plenty of opportunities to get help.
...
* For most weeks there are **core** and **supplementary** tasks. 
  ...
  * **You are required to complete core weekly tasks**. These are *formative* (ungraded) assessments; you will receive group feedback in the weekly workshops to help you improve and prepare for your *summative* (graded) assessments. If you do not complete these, your academic tutor will be asked to speak with you about your progress.
...
## This is a 20-credit module and therefore it is expected it will require 200 study hours per student. Formal teaching hours for this module will take 36 hours (lectures and workshops). Therefore, as a rough guide, this means you should expect to devote around 11 hours of study time per week to this module during a 15-week semester.

The [StudySkills@Sheffield Centre](https://sheffield.ac.uk/academic-skills) offer workshops and resources on time management and study skills. I would strongly recommend booking onto some of these!
...
# Around 10-20% of assessment submissions in this module are referred to an academic misconduct investigation in the past two years. Some students have had to repeat an entire year of study due to misuse of AI. 
...
I run two Consultation and Feedback hours per week, you can ask me questions about EDC117.

If you want to book an appointment with me, please use the calendar [here](https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ0AHE-tqW5ZvjtjlEvH8TEGQSnwYW5GaERacTb18EjlfN7GgHXUbUxPpOKzBeVuJ4L-w04UppOa) or on Blackboard. If no times suit you please get in touch with me by email.
...
# Let's take a quick tour of the Blackboard page for EDC117
...
**Core tasks**:
* Before lecture: Read this module outline and reading/resource list in full
