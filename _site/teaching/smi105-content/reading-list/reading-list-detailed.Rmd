...
### Week 10: Visualising Networks and Using SQL

**Lecture**: In the lecture, we'll talk about types of data that cannot be represented through simple mapping onto axes, using the example of networks. We will talk about the challenges of visualising networks and how the choices and decisions that we need to make when we visualise the data, including the kinds of algorithms we use to organise data and the way we conceptualise "connections" between people or things. 
...
* **Before lecture**: Read *Talking Ties: Reflecting on Network Visualisation and Qualitative Interviewing* [https://journals.sagepub.com/doi/10.5153/sro.3404](https://journals.sagepub.com/doi/10.5153/sro.3404)
* **Before workshop**: Complete the tasks from the previous week's workshop.
